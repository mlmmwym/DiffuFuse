...
class MOSI:
    def __init__(self, config):
        ...
        try:
            print(DATA_PATH + '/new_label_train.pkl')
            self.train = load_pickle(DATA_PATH + '/new_label_train.pkl')
            self.dev = load_pickle(DATA_PATH + '/new_label_dev.pkl')
            self.test = load_pickle(DATA_PATH + '/new_label_test.pkl')
            self.multi = True
            ...
            # Save pickles
            to_pickle(train, DATA_PATH + '/new_label2_train.pkl')
            to_pickle(dev, DATA_PATH + '/new_label2_dev.pkl')
            to_pickle(test, DATA_PATH + '/new_label2_test.pkl')
...
class MOSEI:
    def __init__(self, config):
        ...
        # If cached data if already exists
        try:
            self.train = load_pickle(DATA_PATH + '/new_label2_train.pkl')
            self.dev = load_pickle(DATA_PATH + '/new_label2_dev.pkl')
            self.test = load_pickle(DATA_PATH + '/new_label2_test.pkl')
            self.multi = True
            self.pretrained_emb, self.word2id = None, None
...
class MOSEII:
    def __init__(self, config, is_test=False):
        ...
        self.train = load_pickle(DATA_PATH + '/mos_train.pkl')
        self.dev = load_pickle(DATA_PATH + '/mos_dev.pkl')
        self.mosi_test = load_pickle(DATA_PATH + '/new_mosi_test.pkl')
        self.mosei_test = load_pickle(DATA_PATH + '/new_mosei_test.pkl')

        # self.train = load_pickle(DATA_PATH + '/new_mosi_test.pkl')
        # self.dev = load_pickle(DATA_PATH + '/new_mosi_test.pkl')
        # self.mosi_test = load_pickle(DATA_PATH + '/new_mosi_test.pkl')
        # self.mosei_test = load_pickle(DATA_PATH + '/new_mosi_test.pkl')

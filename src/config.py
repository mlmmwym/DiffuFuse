...
def get_args():
    ...
    # Tasks
    parser.add_argument('--dataset', type=str, default='mosi', choices=['mosi','mosei', 'mos', 'moseld', 'moseldmp', 'iemocap', 'meld', 'emotionlines', 'laptops', 'restaurants'],
    ...
    parser.add_argument('--seed_start', type=int, default=0, help='Start of seed range')
    parser.add_argument('--seed_end', type=int, default=2, help='End of seed range')

    parser.add_argument('--log_name', type=str, default='log.txt', help='End of seed range')
